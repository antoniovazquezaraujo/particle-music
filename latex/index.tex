...
\begin{figure}
  ...
  \end{subfigure}
  \hfill
  \caption{Los siete modos de \sffamily{WHITE}}
  \label{fig:the-six-scales}
\end{figure}
...
\begin{figure}
  ...
  \end{subfigure}
  \hfill
  \caption{Los siete modos de \sffamily{BLUE}}
  \label{fig:the-six-scales}
\end{figure}
...
\begin{figure}
    ...
    \end{subfigure}
    \hfill
    \caption{Los siete modos de \sffamily{RED}}
    \label{fig:the-six-scales}
  \end{figure}
...
\begin{figure}
    ...
    \end{subfigure}
    \hfill
    \caption{Los tres modos de \sffamily{BLACK}}
    \label{fig:the-six-scales}
  \end{figure}
  ...
  \begin{figure}
    ...
    \begin{subfigure}{0.10\textwidth}
      ...
      \label{fig:tikz1}
    \end{subfigure}
    \caption{Los cinco modos de \sffamily{PENTA}}
    \label{fig:the-six-scales}
  \end{figure}
  \begin{figure}
    \begin{subfigure}{0.10\textwidth}
      ...
      \end{subfigure}
      \hfill  
    \caption{El único modo de \sffamily{TONES}}
    \label{fig:the-six-scales}
  \end{figure}
...
\begin{figure}
  ...
  \end{subfigure}
  \hfill
  \caption{Escalas con grados sin tercera}
  \label{fig:scales-with-no-thirds}
\end{figure}
...
\begin{figure}
  ...
  \begin{subfigure}{1\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \draw [->, rounded corners=3mm] (t1-E.north west) rectangle (t1-B.south east);
      \draw [->, rounded corners=3mm] (t2-F.north west) rectangle (t2-C.south east);
      ...
      \draw [->, rounded corners=3mm] (t3-G.north west) rectangle (t4-D.south east);
      \draw [->, rounded corners=3mm] (t4-D.north west) rectangle (t4-A.south east);
      ...
      \draw [->, rounded corners=3mm] (t5-C.north west) rectangle (t5-G.south east);
      \draw [->, rounded corners=3mm] (t6-B.north west) rectangle (t6-F.south east);
      \draw [->, rounded corners=3mm] (t7-A.north west) rectangle (t7-E.south east);
    \end{tikzpicture}    
    \label{fig:tikz2}
  \end{subfigure}
  \caption{Escala \sffamily{WHITE} con sus tríadas}
  \label{fig:white-scale-with-its-triads}
\end{figure}
...
\begin{figure}
  ...
  \begin{subfigure}{1\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \draw [->, rounded corners=3mm] (t1-A.north west) rectangle (t1-e.south east);
      \draw [->, rounded corners=3mm] (t2-B.north west) rectangle (t2-F.south east);
      ...
      \draw [->, rounded corners=3mm] (t3-C.north west) rectangle (t4-G.south east);
      \draw [->, rounded corners=3mm] (t4-G.north west) rectangle (t4-D.south east);
      ...
      \draw [->, rounded corners=3mm] (t5-F.north west) rectangle (t5-C.south east);
      \draw [->, rounded corners=3mm] (t6-e.north west) rectangle (t6-B.south east);
      \draw [->, rounded corners=3mm] (t7-D.north west) rectangle (t7-A.south east);
    \end{tikzpicture}    
    \label{fig:tikz2}
  \end{subfigure}
  \caption{Escala \sffamily{BLUE} con sus tríadas}
  \label{fig:blue-scale-with-its-triads}
\end{figure}
...
\begin{subfigure}{0.30\textwidth}
  \centering
    ...
    \end{tikzpicture}
  \caption{\sffamily{BLUE} con su segundo centro tritonal, reorientada por el oyente para sentir el nuevo centro tonal: \sffamily{G}}
  \label{fig:tikz1}
\end{subfigure}
\hfill
\caption{Modulación cambiando solo en centro tonal}
  ...
  \begin{subfigure}{0.30\textwidth}
    \centering
      \begin{tikzpicture}
        ...
        \draw[ultra thick, color=red] (5) -- (11);
      \end{tikzpicture}
    \caption{\sffamily{BLUE} con dos nuevos centros tritonales que sustituyen al anterior. Se mantiene el mismo centro tonal}
    \label{fig:tikz1}
  \end{subfigure}
  \hfill
  \caption{Modulación cambiando solo en centro tritonal}
...
\begin{figure}
  ...
  \begin{subfigure}{0.30\textwidth}
    \centering
      ...
      \end{tikzpicture}
    \caption{\sffamily{RED} con dos nuevos centros tritonales que sustituyen al anterior. Se despeja un centro tritonal y se sustituye por un centro tonal. Base del flamenco}
    \label{fig:tikz1}
  \end{subfigure}
  \hfill
...
\begin{figure}
  ...
  \begin{subfigure}{0.30\textwidth}
    \centering
      ...
      \end{tikzpicture}
    \caption{Agregamos un tritono. Ahora estamos en \sffamily{RED}}
    \label{fig:tikz1}
  \end{subfigure}
  \hfill
  \hfill
  \begin{subfigure}{0.30\textwidth}
    \centering
      \begin{tikzpicture}
        ...
        \draw[ultra thick, color=red] (6) -- (12);
      \end{tikzpicture}
    \caption{\sffamily{RED} reorientada por el oyente para asimilar el nuevo centro tonal en \sffamily{E}}
    \label{fig:tikz1}
  \end{subfigure}  
  \caption{Modulación base del flamenco}
  \label{fig:modulation-changing-tritonal-center}
...
Uno de los conceptos más utilizados en el jazz es el de la substitución tritonal, que consiste en sustituir directamente la escala que se usa para improvisar sobre un acorde dominante por la de un acorde que está a un tritono de distancia. En ningún momento se da ninguna explicación aceptable, que no sea la relativa a \textit{darle color al acorde para que resulte más interesante}. No es suficiente. En la figura \ref{fig:tritonal-substitution} 
\begin{figure}
	\begin{subfigure}{.30\textwidth}
	  \centering
		\begin{tikzpicture}
	...
	\begin{subfigure}{0.30\textwidth}
	  ...
	  \end{subfigure}
	  \hfill	
    \caption{La base de la substitución tritonal}
	  \label{fig:tritonal-substitution}
	\end{figure}
