...
\begin{tikzpicture}[radius=1.25cm]
  \graph [
    ...
    grow'=up,
    node distance=0pt,    
    nodes={draw,circle, as =  , minimum size=20pt}
  ]
  { 
       1  [draw=none] 
    -- 2  [as= 2] 
  ...
  \draw [] (0,40pt) circle [radius=30pt];
...
\begin{figure}
  ...
  \begin{subfigure}{0.15\textwidth}
    ...
    \end{tikzpicture}    \caption{\sffamily{RED}}
    \label{fig:tikz2}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.15\textwidth}
    ...
    \end{tikzpicture}    \caption{\sffamily{BLACK}}
    \label{fig:tikz2}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.15\textwidth}
    ...
    \end{tikzpicture}    \caption{\sffamily{PENTA}}
    \label{fig:tikz2}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.15\textwidth}
    ...
    \end{tikzpicture}    \caption{\sffamily{TONES}}
    \label{fig:tikz2}
  \end{subfigure}
  \hfill
...
\begin{figure}
  ...
  \begin{subfigure}{0.15\textwidth}
    \centering
      \begin{tikzpicture}
        ...
        \draw[->, ultra thick, color=red] (14.east) -- (32.west);
        \draw[->, ultra thick, color=red] (12.east) -- (34.west);
  ...
  \begin{subfigure}{0.15\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \draw[->, ultra thick, color=red] (15.east) -- (31.west);
      \draw[->, ultra thick, color=red] (11.east) -- (35.west);
  ...
  \begin{subfigure}{0.15\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \draw[->, ultra thick, color=red] (21.north)-- (25.south);
      \draw[->, ultra thick, color=red] (12.east) -- (34.west);
      \draw[->, ultra thick, color=red] (14.east) -- (32.west);
