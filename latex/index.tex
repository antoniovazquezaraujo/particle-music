...
\begin{figure}[H]
  ...
  \begin{subfigure}{0.30\textwidth}
    \centering
      ...
      \end{tikzpicture}
    \caption{\textsf{RED} con dos nuevos centros tritonales que sustituyen al anterior. Se despeja un centro tritonal y se sustituye por un centro tonal. Base del flamenco}
    
  \end{subfigure}
  \hfill
  \caption{Modulación base del flamenco}label{fig:modulation-changing-tritonal-center}
  \end{figure}
