...
\begin{figure}[H]
  ...
  \begin{subfigure}{0.35\textwidth}
    \centering
      ...
      \end{tikzpicture}
    {\captionsetup{justification=raggedright,singlelinecheck=false}\caption{Agregamos un tritono. Ahora estamos en \textsf{RED}}}
...
every label/.style={green},
  ...
  \floatsetup[table]{capposition=beside,capbesideposition={right,center}}
    ...
    \begin{table}[H]
      \centering
        \begin{tabular}{|m{0.6cm}|m{0.6cm}|m{0.6cm}|m{0.6cm}|m{0.6cm}|m{0.6cm}|m{0.6cm}|}
          \hline
